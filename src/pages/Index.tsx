...
export default function Index() {
  ...
  return (
    <div className="min-h-screen" style={{ background: "var(--hostel-dark)", color: "var(--hostel-text)" }}>
      ...
      >
        <span className="font-body text-xs" style={{ color: "var(--hostel-muted)" }}>
          Есть квартиры посуточно — звони!
        </span>
        <Icon name="Home" size={14} style={{ color: "var(--hostel-gold)" } as React.CSSProperties} />
      </a>
      ...
      <section className="py-16 px-6">
        <div className="max-w-5xl mx-auto flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-3">
            ...
            <div
              className="rounded-2xl overflow-hidden relative cursor-pointer group" style={{ height: "clamp(300px, 60vw, 850px)" }}
